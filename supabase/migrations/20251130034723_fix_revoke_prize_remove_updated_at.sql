/*
  # Fix Revoke Prize Transaction - Remove updated_at from egg_redemptions

  ## Issue
  The revoke_prize_transaction function tries to update updated_at column in egg_redemptions,
  but the table doesn't have this column.

  ## Fix
  Remove the updated_at field from the UPDATE statement for egg_redemptions.
*/
