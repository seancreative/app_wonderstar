      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-pink-500 to-pink-600 text-white p-6 rounded-t-2xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black">Create New Voucher</h2>
              <p className="text-pink-100 text-sm">Set up a promotional voucher code</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:outline-none font-mono font-bold uppercase"
            ...
            <div className="md:col-span-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  <Percent className={`w-6 h-6 ${formData.discount_type === 'percentage' ? 'text-pink-600' : 'text-gray-400'}`} />
                ...
                >
                  <DollarSign className={`w-6 h-6 ${formData.discount_type === 'fixed' ? 'text-pink-600' : 'text-gray-400'}`} />
                ...
                >
                  <Gift className={`w-6 h-6 ${formData.discount_type === 'free_gift' ? 'text-pink-600' : 'text-gray-400'}`} />
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:outline-none font-bold uppercase"
                    placeholder="CAKE"
                    maxLength={50}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:outline-none font-bold"
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:outline-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                  />
                </div>
              ...
              <>
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:outline-none font-bold"
                    placeholder="6"
                  />
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-4">
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, restriction_type: 'none' })}
                  ...
                  <div className="border-2 border-gray-200 rounded-xl p-4">
                    ...
                    <div className="relative mb-3">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border-2 border-gray-200 rounded-lg focus:border-pink-500 focus:outline-none text-sm"
                      />
                    </div>
                ...
                {formData.restriction_type === 'special_discount' && (
                  <div className="border-2 border-pink-200 bg-pink-50 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      <AlertCircle className="w-5 h-5 text-pink-600 flex-shrink-0 mt-0.5" />
                      <div className="flex-1">
                        <p className="text-sm font-bold text-pink-900 mb-1">Special Discount Products - Daily Redeemable</p>
                        ...
                        <div className="flex items-center gap-2 p-3 bg-white border border-pink-200 rounded-lg">
          ...
          <div className="flex items-center gap-3 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-pink-500 to-pink-600 text-white rounded-xl font-bold hover:scale-105 transition-transform disabled:opacity-50 disabled:hover:scale-100 shadow-lg"
            >
