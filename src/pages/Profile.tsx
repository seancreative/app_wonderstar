...
const Profile: React.FC = () => {
  ...
  const { balances, loading: balancesLoading, refresh: refreshBalances, source } = useMasterBalances({
    userId: user?.id || null,
            ...
            <div>
              ...
              <div className="flex items-center gap-1 mt-1">
                ...
                <p className="text-xs font-bold text-green-700">
                  {source === 'wpay' ? 'Live from WPay Backend' : 'Calculated from transactions'}
                </p>
              </div>
            </div>
            <button
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className={`p-4 rounded-2xl shadow-lg ${
                    currentTier.name === 'Bronze' ? 'bg-gradient-to-br from-amber-700 to-amber-900' :
