                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {rewards.map((reward) => {
                        ...
                        return (
                          <div
                            key={reward.id}
                            className={`backdrop-blur-xl bg-white/10 border border-white/20 p-4 rounded-3xl space-y-3 transition-all ${canAfford ? 'animate-pulse-gentle hover:scale-105 hover:shadow-glow' : 'opacity-60'
                              }`}
                          >
