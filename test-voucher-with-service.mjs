...
async function testVoucherCreation() {
  console.log('=== VOUCHER CREATION TESTING (With Service Role) ===\n');
  ...
  try {
    ...
    console.log('✅ All voucher types created successfully!\n');
    ...
    if (cleanupError) {
      console.log('❌ Could not clean up:', cleanupError.message);
    } else {
